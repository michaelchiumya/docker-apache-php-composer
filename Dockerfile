...
RUN sed -i "s/short_open_tag = Off/short_open_tag = On/" /etc/php8/apache2/php.ini
RUN sed -i "s/error_reporting = .*$/error_reporting = E_ERROR | E_WARNING | E_PARSE/" /etc/php8/apache2/php.ini
